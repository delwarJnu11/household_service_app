...
from service.views import ServiceDetailsView, ReviewUpdateView, add_to_cart, CartAllItemsView, Cartview, CancelServiceView,AdminCancelServiceView,confirm_oder
